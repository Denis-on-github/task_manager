...
class TestUserViewSet(TestViewSetBase):
    ...
    def test_username_filter(self):
        first_user = self.create({"first_name": "John", "last_name": "Doe", 'username': 'John_Doe', 'email': 'john@test.com'})
        second_user = self.create({"first_name": "Jane", "last_name": "Black", 'username': 'Jane_Black', 'email': 'jane@test.com'})
        third_user = self.create({"first_name": "Alice", "last_name": "Smith", 'username': 'Alice_Smith', 'email': 'alice@test.com'})
